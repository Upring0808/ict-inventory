      ...
      {items.map((item) => {
        ...
        return (
          <div
            ...
            className="group relative cursor-pointer rounded-2xl border border-zinc-200 bg-white p-4 shadow-xs transition-all hover:border-blue-300 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-zinc-700"
          >
